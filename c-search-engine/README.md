...
- [Multi Threaded Web-Crawler](#multi-threaded-web-crawler)
  - [Description](#description)
  - [Features/Deliverables](#featuresdeliverables)
  - [Simple Crawler Flowchart](#simple-crawler-flowchart)
  - [Table of contents](#table-of-contents)
  ...
  - [MULTITHREADED Web Crawler](#multithreaded-web-crawler)
    ...
    - [Crawler loop code](#crawler-loop-code)
    - [Child Thread code](#child-thread-code)
  ...
  - [Website domain ranking algorithms](#website-domain-ranking-algorithms)
    - [Simple counter based](#simple-counter-based)
      - [Demo run](#demo-run)
  - [Domain Name rankings using counter](#domain-name-rankings-using-counter)
    - [Sampling based PageRank algorithm](#sampling-based-pagerank-algorithm)
      - [Demo run](#demo-run-1)
  - [Domain Name ranking using PageRank: Sampling (n = 10000)](#domain-name-ranking-using-pagerank-sampling-n--10000)
    - [Iterative based PageRank algorithm](#iterative-based-pagerank-algorithm)
      - [Demo run](#demo-run-2)
  - [Domain Name ranking using PageRank: Iteration](#domain-name-ranking-using-pagerank-iteration)
  - [Graphs](#graphs)
